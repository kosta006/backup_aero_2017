...
module.exports = {
  ...
  */
  ...
  shadows: {
    default: `0 -2px 4px 0 ${colors['white']}`,
    'md': `0 -4px 8px 0 ${colors['white']}, 0 -2px 4px 0 ${colors['white']}`, // '0 4px 8px 0 rgba(0,0,0,0.12), 0 2px 4px 0 rgba(0,0,0,0.08)'
    'lg': `0 -15px 30px 0 ${colors['white']}, 0 -5px 15px 0 ${colors['white']}`, // '0 15px 30px 0 rgba(0,0,0,0.11), 0 5px 15px 0 rgba(0,0,0,0.08)'
    'inner': `inset 0 -2px 4px 0 ${colors['white']}`,
    'none': 'none',
  },
