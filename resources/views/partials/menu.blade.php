<nav class="flex flex-col md:flex-row md:items-baseline md:justify-between max-w-md mx-auto md:px-12 text-5xl md:text-lg font-hairline md:font-light uppercase md:normal-case" role="navigation" aria-label="site links">
