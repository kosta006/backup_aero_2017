<nav class="flex flex-col md:flex-row md:items-baseline md:justify-between {{ r($page->isHomePage(), 'lg:max-w-2xl', 'md:max-w-lg') }} mx-auto md:px-8 text-5xl md:text-lg font-hairline md:font-light uppercase md:normal-case" role="navigation" aria-label="site links">
